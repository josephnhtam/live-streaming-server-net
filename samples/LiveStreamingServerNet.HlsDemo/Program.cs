...
namespace LiveStreamingServerNet.HlsDemo
{
    public static class Program
    {
        ...
        public class TransmuxerEventListener : ITransmuxerEventHandler
        {
            ...
            public Task OnTransmuxerStartedAsync(string inputPath, string outputPath, string streamPath, IDictionary<string, string> streamArguments)
            {
            ...
            public Task OnTransmuxerStoppedAsync(string inputPath, string outputPath, string streamPath, IDictionary<string, string> streamArguments)
            {
                outputPath = Path.GetRelativePath(_config.OutputDirectoryPath, outputPath);
