...
using LiveStreamingServerNet.Rtmp.Server.Internal.RtmpEventHandlers.UserControls;
using LiveStreamingServerNet.Utilities.Buffers.Contracts;
using NSubstitute;

namespace LiveStreamingServerNet.Rtmp.Server.Test.RtmpEventHandlers.UserControls
{
